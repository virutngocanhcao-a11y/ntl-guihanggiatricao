      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6">
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-8">
            <div>
              <div className="inline-flex items-center gap-2 rounded-full border border-[#d99400]/30 bg-[#fdd800]/15 px-4 py-1.5 text-xs font-bold uppercase tracking-wider text-[#b37700]">
                <Icon name="shield-check" className="h-4 w-4 text-[#b37700]" />
                Giải pháp B2B Chuyên Biệt
              </div>
              <h2 className="mt-4 text-3xl font-extrabold text-[#1a1a1a] md:text-4xl lg:text-5xl leading-tight">
